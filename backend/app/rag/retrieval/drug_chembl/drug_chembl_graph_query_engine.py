...
class DrugChEMBLText2CypherEngine:
    ...
    def __init__(self, config):
        ...
        self.table_node_mapping = SimpleObjectNodeMapping.from_objects(self.table_schema_objs)
    ...
    def execute_graph_query(self, queries):
        logger.debug(f"DrugChEMBLText2CypherEngine.execute_graph_query queries: {queries}")
        ...
        logger.debug(f"DrugChEMBLText2CypherEngine.execute_graph_query query_list: {query_list}")
        results = []
        ...
        logger.debug(f"DrugChEMBLText2CypherEngine.execute_graph_query results: {results}")
    ...
    def get_all_table_info(self):
        ...
        logger.debug(f"DrugChEMBLText2CypherEngine.get_all_table_info table_infos: {len(table_infos)}")
        return table_infos
    ...
    def cypher_output_parser(self, response: list[dict[str, list]]) -> str:
        ...
        logger.debug(f"DrugChEMBLText2CypherEngine.cypher_output_parser response_str: {response_str}")
        return response_str
    ...
    def build_query_pipeline(self):
        ...
        qp.add_link("table_output_parser", "cypher_query_retriever_prompt", dest_key="schema")
        ...
        qp.add_link("cypher_query_retriever_llm", "response_synthesis_prompt", dest_key="cypher_query")
        qp.add_link("cypher_output_parser", "response_synthesis_prompt", dest_key="context_str")

...
TOGETHER_PROMPT_CONFIG: dict = config(
...
# table info dir
CLINICAL_TRIALS_TABLE_INFO_DIR: str = config(
    "CLINICAL_TRIALS_TABLE_INFO_DIR",
    default="app/rag/retrieval/clinical_trials/AACTTableQuestions_TableInfo",
)
POSTGRES_ENGINE: Secret = config("POSTGRES_ENGINE", cast=Secret)

## Drug ChEMBL Configurations Details
# table info dir
DRUG_CHEMBL_TABLE_INFO_DIR: str = config(
    "DRUG_CHEMBL_TABLE_INFO_DIR",
    default="app/rag/retrieval/drug_chembl/ChEMBLTableQuestions_TableInfo",
)
